...
export const deliveryService = {
  ...
  /**
   * Looks up the recipient email from the data source record that was used to
   * generate the document — so the Send modal can pre-fill it automatically.
   * Returns { email, recipientName, source } or { email: null }.
   */
  getRecipientEmail: (docId) => api.get(`/documents/${docId}/recipient-email`),
  /**
...
export const auditService = {
  ...
  /** Scoped dashboard stats for the current user — safe for generator & approver. */
  getMyDashboardStats: () => api.get('/dashboard/my-stats'),
