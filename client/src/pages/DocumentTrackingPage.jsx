        ...
        <>
          <div className="doc-card-actions">
            ...
            {ownershipRejectionBanner && isSignedOrDelivered && (
              <button type="button" onClick={() => onEditResubmit(ownershipRejectionBanner)} className="doc-btn doc-btn-primary" style={{ background: 'var(--error-text)', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
