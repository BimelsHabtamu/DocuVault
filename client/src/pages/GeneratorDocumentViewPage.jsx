        ...
        {DELIVERY_METHODS.map((m) => {
          ...
          return (
            ...
            >
              ...
              <span>
                <span style={{ display: 'block', fontWeight: 600, fontSize: '0.85rem', color: selected ? 'var(--brand-text)' : 'var(--text-primary)' }}>
                  {m.label}{selected && (
                    <span style={{ marginLeft: 6, color: 'var(--brand)', display: 'inline-flex', verticalAlign: 'middle' }}>
