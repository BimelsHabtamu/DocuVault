      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rp-hero {
          ...
          overflow: hidden;
          background: linear-gradient(148deg, #0D5E58 0%, #0F766E 50%, #115E59 100%);
        }
        ...
        html.dark .rp-right { background: #0A1628; }
        ...
        .rp-card h1 {
          ...
          color: #1E293B; margin-bottom: 2px; line-height: 1.2;
        }
        html.dark .rp-card h1 { color: #E8F4F2; }
        .rp-sub {
          font-size: 0.8rem; color: #64748B;
          margin-bottom: 18px; line-height: 1.45;
        }
        html.dark .rp-sub { color: #8BB4AE; }
        ...
        html.dark .rp-err { background:rgba(220,38,38,.12); border-color:rgba(248,113,113,.3); color:#F87171; }
        .rp-field-err { margin: 3px 0 0; font-size: 12px; color: #DC2626; }
        html.dark .rp-field-err { color: #F87171; }
        .rp-req { color: #DC2626; }
        .rp-inp[aria-invalid="true"] { border-color: #DC2626 !important; }
        .rp-inp[aria-invalid="true"]:focus {
          border-color: #DC2626;
        ...
        html.dark .rp-inp { background: #1A2F42; border-color: #1E3D4F; color: #E8F4F2; }
        html.dark .rp-inp:focus { border-color: #14B8A6; background: #142538; box-shadow: 0 0 0 3px rgba(20,184,166,.15); }
        html.dark .rp-inp::placeholder { color: #5A8880; }
        ...
        .rp-eye:hover { color: #0F766E; }
        html.dark .rp-eye { color: #5A8880; }
        html.dark .rp-eye:hover { color: #14B8A6; }
        ...
        html.dark .rp-strength-bar { background: #1E3D4F; }
        ...
        html.dark .rp-strength-label { color: #5A8880; }
        ...
        .rp-btn:hover:not(:disabled) { opacity:.9; transform:translateY(-1px); box-shadow:0 6px 18px rgba(15,118,110,.48); }
        ...
        html.dark .rp-success h1 { color: #E8F4F2; }
        .rp-success-msg {
          font-size: 0.82rem; color: #64748B;
          text-align: center; line-height: 1.6;
        }
        html.dark .rp-success-msg { color: #8BB4AE; }
        .rp-success-notice {
          padding: 10px 13px;
          background: rgba(15,118,110,0.07);
          border: 1px solid rgba(20,184,166,0.2);
          border-radius: 9px;
          font-size: 0.77rem; color: #0F766E; line-height: 1.5; text-align: center;
        }
        html.dark .rp-success-notice { background:rgba(20,184,166,.10); border-color:rgba(20,184,166,.25); color:#14B8A6; }
        ...
        html.dark .rp-div {
          background: linear-gradient(90deg, transparent, #1E3D4F 30%, #1E3D4F 70%, transparent);
        }
        ...
        .rp-back:hover { color: #115E59; text-decoration: underline; }
        html.dark .rp-back { color: #14B8A6; }
        html.dark .rp-back:hover { color: #5EEAD4; }
                ...
                <form onSubmit={handleSubmit} noValidate>
                  ...
                  <div className="rp-field">
                    ...
                    {newPw.length > 0 && (() => {
                      ...
                      // Must have letters to be above Weak
                      ...
                      return (
                        <>
                          <div className="rp-strength">
                            {[1,2,3,4].map(i => (
                              <div key={i} className={`rp-strength-bar${i <= score ? ' ' + cls[score] : ''}`}/>
                            ))}
                          </div>
                          <div className="rp-strength-label" style={{ color: score > 0 ? colors[score] : undefined }}>
                            {labels[score]}
                          </div>
                          <ul style={{ margin: '6px 0 0', padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 2 }}>
                            {reqs.map(r => (
                              <li key={r.text} style={{ fontSize: '0.68rem', display: 'flex', alignItems: 'center', gap: 5,
