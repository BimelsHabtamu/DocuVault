...
function StepBadge({ n, active, done }) {
  const bg  = done ? '#16A34A' : active ? '#0F766E' : '#E2E8F0';
...
function ActionBtn({ onClick, disabled, loading, children, variant = 'primary', style = {} }) {
  const variants = {
    ...
    indigo:    { background: 'var(--brand)',             color: 'var(--text-inverse)' },
  };
  return (
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td style={{ width: '62%', paddingLeft: 8, verticalAlign: 'bottom' }}>
                                    <div style={{ border: '1.5px solid var(--brand)', borderRadius: 4, minHeight: 36,
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                              {signPhotoUrl ? (
                                ...
                                <label style={{
                                  display: 'inline-flex', alignItems: 'center', gap: 7,
                                  padding: '10px 16px',
                                  background: ownershipStatus !== 'CONFIRMED' ? 'var(--bg-subtle)' : 'var(--accent-light)',
                                  border: '1.5px dashed var(--accent)', borderRadius: 8,
