    ...
    <div className="user-management-page">
      ...
      {showForm && (
        <form className="template-form" onSubmit={handleCreate} noValidate style={{ maxWidth: 480, marginBottom: 24 }}>
          ...
          <div className="form-field">
            <label htmlFor="new-name">Full Name <RequiredMark /></label>
            <input
              id="new-name"
              value={form.full_name}
              onChange={handleChange('full_name')}
              placeholder="e.g. Lij Grma"
              {...fieldProps('full_name', { errorId: 'new-name-error' })}
            />
            <FieldError id="new-name-error" message={errors.full_name} />
          </div>
          <div className="form-field">
            <label htmlFor="new-organization">Organization / Company / Institution <RequiredMark /></label>
            <input
              id="new-organization"
              value={form.organization}
              onChange={handleChange('organization')}
              placeholder="Your organization will appear on the invite email"
              {...fieldProps('organization', { errorId: 'new-organization-error' })}
            />
            <FieldError id="new-organization-error" message={errors.organization} />
          </div>
          <div className="form-field">
            <label htmlFor="new-role">Role <RequiredMark /></label>
          ...
          <div className="form-field">
            <label htmlFor="new-phone">Phone <span className="field-optional">(optional)</span></label>
            <input id="new-phone" value={form.phone} onChange={handleChange('phone')} placeholder="+251 9XX XXX XXX" />
