...
export function IconDashboard() {
  return (
    <svg {...common}>
      <rect x="3" y="3" width="7.5" height="7.5" rx="1.5" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <rect x="13.5" y="3" width="7.5" height="7.5" rx="1.5" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <rect x="3" y="13.5" width="7.5" height="7.5" rx="1.5" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <rect x="13.5" y="13.5" width="7.5" height="7.5" rx="1.5" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconVerify() {
  return (
    <svg {...common}>
      ...
      <path d="M8.5 11L10.2 12.8L13.5 9.2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16.5 16.5L21 21" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}

export function IconMyReceivedDocs() {
  return (
    <svg {...common}>
      <path d="M4 4h10l4 4v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <path d="M14 4v4h4" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <path d="M12 13v4M10 15l2 2 2-2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

// M-2: Recipient area — inbox-style icon
export function IconRecipientDocs() {
  return (
    <svg {...common}>
      <path d="M4 4.5H20C20.55 4.5 21 4.95 21 5.5V15.5C21 16.05 20.55 16.5 20 16.5H4C3.45 16.5 3 16.05 3 15.5V5.5C3 4.95 3.45 4.5 4 4.5Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
      <path d="M3 7L12 12L21 7" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M9 19.5H15" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
      <path d="M12 16.5V19.5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  );
}
