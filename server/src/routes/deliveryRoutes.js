...
// GET /documents/:id/recipient-email — auto-fetch the recipient email from the data source record
// so the Send modal can pre-fill it. Read-only; no state changes.
router.get('/documents/:id/recipient-email', requireAuth, canDeliver, getRecipientEmailForDoc);
